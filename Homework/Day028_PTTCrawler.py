...
# 範例目標網址: https://www.ptt.cc/bbs/Gossiping/M.1557928779.A.0C1.html(此網址無效)
#更改目標網址為: 'https://www.ptt.cc/bbs/Gossiping/M.1614854870.A.764.html'
class PttcrawlerSpider(scrapy.Spider):
    name = 'PTTCrawler'
    allowed_domains = ['www.ptt.cc']
    start_urls = ['https://www.ptt.cc/bbs/Gossiping/M.1614854870.A.764.html']
    cookies = {'over18': '1'}
